...
def quickstart_flow() -> None:
    ...
    lines = [
        ...
        '  <text x="870" y="100" fill="#6b7280" font-size="9" text-anchor="middle">hy3-preview</text>',
...
def cos_persistence() -> None:
    ...
    lines = [
        ...
        '  <text x="250" y="240" fill="#6b7280" font-size="11" text-anchor="middle">test:full · no HARNESS_COS_* required</text>',
...
def claude_models() -> None:
    ...
    lines = [
        ...
        '  <text x="260" y="150" fill="#6a6a6a" font-size="12" text-anchor="middle">hy3-preview via Anthropic-compatible gateway</text>',
...
def test_scenarios() -> None:
    ...
    lines = [
        ...
        '  <text x="180" y="100" fill="#22d3ee" font-family="JetBrains Mono, monospace" font-size="12" font-weight="600" text-anchor="middle">local / test:full</text>',
        ...
        '  <text x="180" y="190" fill="#64748b" font-family="JetBrains Mono, monospace" font-size="9" text-anchor="middle">npm run test:full</text>',
        '  <rect x="360" y="70" width="280" height="140" rx="8" fill="#0f172a" stroke="#34d399" stroke-width="1.5"/>',
        '  <text x="500" y="100" fill="#34d399" font-family="JetBrains Mono, monospace" font-size="12" font-weight="600" text-anchor="middle">cloud-tcbr</text>',
        ...
        '  <text x="500" y="190" fill="#64748b" font-family="JetBrains Mono, monospace" font-size="9" text-anchor="middle">harness -- cloud-tcbr</text>',
        '  <rect x="680" y="70" width="280" height="140" rx="8" fill="#0f172a" stroke="#fbbf24" stroke-width="1.5"/>',
        '  <text x="820" y="100" fill="#fbbf24" font-family="JetBrains Mono, monospace" font-size="12" font-weight="600" text-anchor="middle">cloud-scf</text>',
        ...
        '  <text x="820" y="190" fill="#64748b" font-family="JetBrains Mono, monospace" font-size="9" text-anchor="middle">harness -- cloud-scf</text>',
