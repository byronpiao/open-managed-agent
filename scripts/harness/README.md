...
| **仓库维护者** | 验收矩阵、发版镜像、对齐 AGS tool | 下文「维护者脚本」· [Harness一条龙.md](../../../Harness一条龙.md) |
...
| 脚本 | 何时跑 |
|------|--------|
| `build-push-magent-public.sh` | TRW magent 有变更，要 bump `HARNESS_PUBLIC_MAGENT_IMAGE` 并推公共 CCR |
