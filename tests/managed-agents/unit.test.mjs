...
const runtimeDist = join(root, "packages/agent-runtime/dist/harness/managed-agents-protocol/index.js");
...
const harnessPromptRunnerSrc = readFileSync(
  join(root, "packages/agent-runtime/dist/harness/managed-agents-protocol/dispatch/harness-prompt-runner.js"),
  "utf8",
);
assert.ok(
